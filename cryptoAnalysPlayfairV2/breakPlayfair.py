...
class CipherBreakerApp:
    ...
    def break_cipher_thread(self):
        try:
            ...
            encrypted_file = f"{base_name}_encrypted.txt"  # Новый файл для зашифрованного текста
            ...
            self.append_result(f"Зашифрованный текст сохранен в: {encrypted_file}\n")
            self.append_result(f"Первые 100 символов: {ciphertext[:100]}...\n")
            ...
            messagebox.showinfo("Готово",
                                f"Зашифрованный текст сохранен в:\n{encrypted_file}\n"
                                f"Расшифрованный текст сохранен в:\n{output_file}")
